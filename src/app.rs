...
use crate::{component::Component, system::{BaseSystem, ComponentSystem}, world::{World, UnsafeWorldContainer}};
...
impl App {
        ...
        <Sys as ComponentSystem>::ComponentType: Component + 'static
    {
        ...
        self.world_container.get_world_mut().register_component::<<Sys as ComponentSystem>::ComponentType>();
